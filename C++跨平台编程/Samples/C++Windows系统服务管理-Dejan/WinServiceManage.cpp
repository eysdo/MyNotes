...
namespace sc
{
	class CWinServiceManage : public WinServiceManage
	{
	private:
	...
	/* 工厂方法 */
	WinServiceManage* WinServiceManage::Get()
	{
		static WinServiceManage* wsm = 0;
		if (0 == wsm)
		{
			static CWinServiceManage c_wsm;
			wsm = &c_wsm;
		}
		return wsm;
	}

	WinServiceManage::WinServiceManage()
	{
	}
